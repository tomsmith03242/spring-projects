...
<!-- <body style="background-repeat: no-repeat; background-size: cover; background-color: #1d50e6;"> -->
<body style="background-repeat: no-repeat; background-size: cover; background-color: white;">
		...
		<div class="container" style="margin: 30px auto; padding: 15px auto;">
			<!-- <a href="/"><img src="resources/images/loggo.png" alt="Tekko"
				style="height: 50%; width: 20%;" /></a> --><br /> <br />
						...
						<h4 style="color:red;">You don't have access to this page </h4>
						</div>
